...
local PresetColor = Color3.fromRGB(180, 30, 30)
...
-- ═══════════════════════════════════════════
-- LUCIDE ICONS (subset mapped to Roblox assets)
-- ═══════════════════════════════════════════
local LucideIcons = {
	["home"]         = "rbxassetid://11294454613",
	["settings"]     = "rbxassetid://11294454948",
	["search"]       = "rbxassetid://11294454877",
	["star"]         = "rbxassetid://11294454992",
	["heart"]        = "rbxassetid://11294454691",
	["zap"]          = "rbxassetid://11294455054",
	["shield"]       = "rbxassetid://11294454904",
	["sword"]        = "rbxassetid://11294454904",
	["user"]         = "rbxassetid://11294455024",
	["users"]        = "rbxassetid://11294455024",
	["eye"]          = "rbxassetid://11294454641",
	["map"]          = "rbxassetid://11294454776",
	["target"]       = "rbxassetid://11294454992",
	["activity"]     = "rbxassetid://11294454613",
	["alert"]        = "rbxassetid://11294454613",
	["box"]          = "rbxassetid://11294454613",
	["check"]        = "rbxassetid://11294454613",
	["clock"]        = "rbxassetid://11294454613",
	["code"]         = "rbxassetid://11294454613",
	["cpu"]          = "rbxassetid://11294454613",
	["database"]     = "rbxassetid://11294454613",
	["flame"]        = "rbxassetid://11294454613",
	["gamepad"]      = "rbxassetid://11294454613",
	["globe"]        = "rbxassetid://11294454613",
	["key"]          = "rbxassetid://11294454613",
	["layers"]       = "rbxassetid://11294454613",
	["list"]         = "rbxassetid://11294454613",
	["lock"]         = "rbxassetid://11294454613",
	["menu"]         = "rbxassetid://11294454613",
	["moon"]         = "rbxassetid://11294454613",
	["package"]      = "rbxassetid://11294454613",
	["play"]         = "rbxassetid://11294454613",
	["power"]        = "rbxassetid://11294454613",
	["refresh"]      = "rbxassetid://11294454613",
	["slash"]        = "rbxassetid://11294454613",
	["sliders"]      = "rbxassetid://11294454613",
	["sun"]          = "rbxassetid://11294454613",
	["terminal"]     = "rbxassetid://11294454613",
	["tool"]         = "rbxassetid://11294454613",
	["trash"]        = "rbxassetid://11294454613",
	["trending"]     = "rbxassetid://11294454613",
	["wifi"]         = "rbxassetid://11294454613",
	["x"]            = "rbxassetid://11294454613",
	["crosshair"]    = "rbxassetid://11294454613",
}

-- Helper: resolve icon (accepts lucide name or rbxassetid string)
local function ResolveIcon(ico)
	if ico == nil or ico == "" then return "" end
	if LucideIcons[ico:lower()] then
		return LucideIcons[ico:lower()]
	end
	return ico
end

-- ═══════════════════════════════════════════
-- AUTO SAVE (uses DataStoreService if available, fallback to _G table)
-- ═══════════════════════════════════════════
local SaveData = {}
local SaveKey = "MidNightUI_v1"
local DataStore = nil
pcall(function()
	DataStore = game:GetService("DataStoreService"):GetDataStore(SaveKey)
	local ok, saved = pcall(function() return DataStore:GetAsync(tostring(LocalPlayer.UserId)) end)
...
local function AutoSave()
	pcall(function()
		if DataStore then
			DataStore:SetAsync(tostring(LocalPlayer.UserId), SaveData)
		end
	end)
	_G[SaveKey] = SaveData
end
...
UserInputService.InputBegan:Connect(function(input, gp)
	...
	for _, kb in next, KeybindRegistry do
...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	PresetColor = mainclr or Color3.fromRGB(180, 30, 30)
	local fs = false
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(30, 8, 8)
	LeftFrame.Size = UDim2.new(0, 170, 0, 380)
	...
	GlowTabHolder.ImageColor3 = Color3.fromRGB(80, 0, 0)
	...
	-- Gradient vermelho-preto no fundo do MainFrame
	...
	-- Gradient vermelho-preto no LeftFrame
	...
	LeftGradient.Parent = LeftFrame

	-- Tabela global de funções registradas para o search
	local SearchRegistry = {}

	-- Search bar acima das abas
	...
	local SearchResultsPanel = Instance.new("Frame")
	...
	local SearchResultsScrollLayout = Instance.new("UIListLayout")

	SearchFrame.Name = "SearchFrame"
	SearchFrame.Parent = LeftFrame
	SearchFrame.BackgroundColor3 = Color3.fromRGB(50, 8, 8)
	SearchFrame.BorderSizePixel = 0
	SearchFrame.Position = UDim2.new(0.039, 0, 0.158, 0)
	...
	SearchIcon.Text = "🔍"
	SearchIcon.TextColor3 = Color3.fromRGB(200, 80, 80)
	...
	SearchBox.PlaceholderText = "Buscar função..."
	SearchBox.PlaceholderColor3 = Color3.fromRGB(160, 60, 60)
	SearchBox.Text = ""
	...
	-- Painel flutuante de resultados ao lado
	SearchResultsPanel.Name = "SearchResultsPanel"
	SearchResultsPanel.Parent = MainFrame
	SearchResultsPanel.BackgroundColor3 = Color3.fromRGB(22, 5, 5)
	SearchResultsPanel.BorderSizePixel = 0
	SearchResultsPanel.Position = UDim2.new(0, 178, 0, 8)
	SearchResultsPanel.Size = UDim2.new(0, 370, 0, 280)
	SearchResultsPanel.Visible = false
	SearchResultsPanel.ZIndex = 20
	SearchResultsPanel.ClipsDescendants = true

	SearchResultsCorner.CornerRadius = UDim.new(0, 6)
	SearchResultsCorner.Parent = SearchResultsPanel

	local SRGradient = Instance.new("UIGradient")
	SRGradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 5, 5)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 0, 0))
	})
	SRGradient.Rotation = 180
	SRGradient.Parent = SearchResultsPanel

	SearchResultsTitle.Name = "SearchResultsTitle"
	SearchResultsTitle.Parent = SearchResultsPanel
	SearchResultsTitle.BackgroundTransparency = 1
	SearchResultsTitle.Position = UDim2.new(0, 10, 0, 5)
	SearchResultsTitle.Size = UDim2.new(1, -20, 0, 20)
	SearchResultsTitle.Font = Enum.Font.GothamBold
	SearchResultsTitle.Text = "Resultados"
	SearchResultsTitle.TextColor3 = Color3.fromRGB(200, 80, 80)
	SearchResultsTitle.TextSize = 12
	SearchResultsTitle.TextXAlignment = Enum.TextXAlignment.Left
	SearchResultsTitle.ZIndex = 21

	SearchResultsScroll.Name = "SearchResultsScroll"
	SearchResultsScroll.Parent = SearchResultsPanel
	SearchResultsScroll.BackgroundTransparency = 1
	SearchResultsScroll.BorderSizePixel = 0
	SearchResultsScroll.Position = UDim2.new(0, 0, 0, 28)
	SearchResultsScroll.Size = UDim2.new(1, 0, 1, -28)
	SearchResultsScroll.CanvasSize = UDim2.new(0, 0, 0, 0)
	SearchResultsScroll.ScrollBarThickness = 3
	SearchResultsScroll.ScrollBarImageColor3 = Color3.fromRGB(150, 30, 30)
	SearchResultsScroll.ZIndex = 21

	SearchResultsScrollLayout.Name = "SearchResultsScrollLayout"
	SearchResultsScrollLayout.Parent = SearchResultsScroll
	SearchResultsScrollLayout.SortOrder = Enum.SortOrder.LayoutOrder
	SearchResultsScrollLayout.Padding = UDim.new(0, 4)

	-- Função para atualizar resultados buscando nas funções registradas
	local function UpdateSearchResults(query)
		for _, v in next, SearchResultsScroll:GetChildren() do
		...
		local found = 0
		for _, entry in next, SearchRegistry do
			if entry.text:lower():find(query:lower(), 1, true) then
				found = found + 1
				local ResultItem = Instance.new("TextButton")
				local ResultCorner = Instance.new("UICorner")
				local ResultDot = Instance.new("Frame")
				local ResultDotCorner = Instance.new("UICorner")
				local ResultLabel = Instance.new("TextLabel")
				local ResultTab = Instance.new("TextLabel")

				ResultItem.Name = "ResultItem"
				ResultItem.Parent = SearchResultsScroll
				ResultItem.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
				ResultItem.BorderSizePixel = 0
				ResultItem.Size = UDim2.new(1, -10, 0, 40)
				ResultItem.Position = UDim2.new(0, 5, 0, 0)
				ResultItem.AutoButtonColor = false
				ResultItem.Font = Enum.Font.SourceSans
				ResultItem.Text = ""
				ResultItem.ZIndex = 22

				ResultCorner.CornerRadius = UDim.new(0, 4)
				ResultCorner.Parent = ResultItem

				ResultDot.Parent = ResultItem
				ResultDot.BackgroundColor3 = Color3.fromRGB(200, 60, 60)
				ResultDot.AnchorPoint = Vector2.new(0, 0.5)
				ResultDot.Position = UDim2.new(0, 8, 0.5, 0)
				ResultDot.Size = UDim2.new(0, 7, 0, 7)
				ResultDot.ZIndex = 23
				ResultDotCorner.CornerRadius = UDim.new(1, 0)
				ResultDotCorner.Parent = ResultDot

				ResultLabel.Parent = ResultItem
				ResultLabel.BackgroundTransparency = 1
				ResultLabel.Position = UDim2.new(0, 22, 0, 3)
				ResultLabel.Size = UDim2.new(1, -26, 0, 20)
				ResultLabel.Font = Enum.Font.Gotham
				ResultLabel.Text = entry.text
				ResultLabel.TextColor3 = Color3.fromRGB(255, 220, 220)
				ResultLabel.TextSize = 12
				ResultLabel.TextXAlignment = Enum.TextXAlignment.Left
				ResultLabel.ZIndex = 23

				ResultTab.Parent = ResultItem
				ResultTab.BackgroundTransparency = 1
				ResultTab.Position = UDim2.new(0, 22, 0, 22)
				ResultTab.Size = UDim2.new(1, -26, 0, 14)
				ResultTab.Font = Enum.Font.Gotham
				ResultTab.Text = "📁 " .. (entry.tabName or "?")
				ResultTab.TextColor3 = Color3.fromRGB(160, 60, 60)
				ResultTab.TextSize = 10
				ResultTab.TextXAlignment = Enum.TextXAlignment.Left
				ResultTab.ZIndex = 23
				...
				ResultItem.MouseEnter:Connect(function()
					TweenService:Create(ResultItem, TweenInfo.new(.2), {BackgroundColor3 = Color3.fromRGB(90, 15, 15)}):Play()
				end)
				ResultItem.MouseLeave:Connect(function()
					TweenService:Create(ResultItem, TweenInfo.new(.2), {BackgroundColor3 = Color3.fromRGB(55, 10, 10)}):Play()
				end)
			end
		end
		SearchResultsScroll.CanvasSize = UDim2.new(0, 0, 0, SearchResultsScrollLayout.AbsoluteContentSize.Y + 10)
		SearchResultsPanel.Visible = found > 0
	end
	...
	TabHold.Position = UDim2.new(0, 0, 0.210, 0)
	TabHold.Size = UDim2.new(0, 170, 0, 290)
	...
	Drag.Size = UDim2.new(0, 410, 0, 20)
	...
	MainFrame:TweenSize(UDim2.new(0, 580, 0, 380), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)

	-- Botão flutuante para abrir/fechar UI
	local ToggleBtn = Instance.new("ImageButton")
	local ToggleBtnCorner = Instance.new("UICorner")
	local ToggleBtnGlow = Instance.new("ImageLabel")

	ToggleBtn.Name = "ToggleBtn"
	ToggleBtn.Parent = FluxLib
	ToggleBtn.AnchorPoint = Vector2.new(0.5, 0.5)
	ToggleBtn.BackgroundColor3 = Color3.fromRGB(20, 5, 5)
	ToggleBtn.BorderSizePixel = 0
	ToggleBtn.Position = UDim2.new(0.05, 0, 0.85, 0)
	ToggleBtn.Size = UDim2.new(0, 52, 0, 52)
	ToggleBtn.AutoButtonColor = false
	ToggleBtn.Image = "rbxassetid://84427155383225"
	...
	ToggleBtnGlow.BorderSizePixel = 0
	ToggleBtnGlow.Position = UDim2.new(0, -12, 0, -12)
	ToggleBtnGlow.Size = UDim2.new(1, 24, 1, 24)
	ToggleBtnGlow.ZIndex = 99
	ToggleBtnGlow.Image = "rbxassetid://4996891970"
	ToggleBtnGlow.ImageColor3 = Color3.fromRGB(180, 20, 20)
	ToggleBtnGlow.ImageTransparency = 0.4
	ToggleBtnGlow.ScaleType = Enum.ScaleType.Slice
	ToggleBtnGlow.SliceCenter = Rect.new(20, 20, 280, 280)
	...
	ToggleBtn.MouseButton1Click:Connect(function()
		if uitoggled == false then
			...
			TweenService:Create(ToggleBtnGlow, TweenInfo.new(.3), {ImageColor3 = Color3.fromRGB(80, 10, 10)}):Play()
			uitoggled = true
			wait(.4)
			MainFrame.Visible = false
		else
			MainFrame.Visible = true
			MainFrame:TweenSize(UDim2.new(0, 580, 0, 380), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .4, true)
			TweenService:Create(ToggleBtnGlow, TweenInfo.new(.3), {ImageColor3 = Color3.fromRGB(180, 20, 20)}):Play()
			uitoggled = false
		end
	end)
	...
	function Flux:Notification(desc,buttontitle)
		...
		NotificationBase.Size = UDim2.new(0, 580, 0, 380)
		...
		NotificationFrame.BackgroundColor3 = Color3.fromRGB(18, 5, 5)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
		...
		NotificationFrame:TweenSize(UDim2.new(0, 340, 0, 200), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
	...
	function Tabs:Tab(text,ico)
		...
		Tab.Name = "Tab"
		Tab.Parent = TabHold
		Tab.BackgroundColor3 = Color3.fromRGB(70, 10, 10)
		Tab.BorderSizePixel = 0
		Tab.Size = UDim2.new(0, 170, 0, 30)
		...
		Container.Size = UDim2.new(0, 385, 0, 340)
		Container.CanvasSize = UDim2.new(0, 0, 0, 0)
		Container.ScrollBarThickness = 5
		Container.Visible = false
		Container.ScrollBarImageColor3 = Color3.fromRGB(150, 30, 30)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			Button.Size = UDim2.new(0, 365, 0, 43)
			...
			CircleSmall.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			...
			Description.Size = UDim2.new(0, 345, 0, 31)
			...
			ArrowBtn.BackgroundColor3 = Color3.fromRGB(100, 15, 15)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if BtnDescToggled == false then
					Button:TweenSize(UDim2.new(0, 365, 0, 74), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
					...
					Button:TweenSize(UDim2.new(0, 365, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
			-- Registrar no search
			table.insert(SearchRegistry, {text = text, tabName = TabTitle.Text, callback = callback})
		end
		function ContainerContent:Toggle(text, desc,default, callback)
			local ToggleDescToggled = false
			local Toggled = false
			-- Restore AutoSaved value
			if SaveData[text] ~= nil then
				Toggled = SaveData[text]
				default = Toggled
			end
			if desc == "" then
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Toggle.ClipsDescendants = true
			Toggle.Position = UDim2.new(0.110937506, 0, 0.67653507, 0)
			Toggle.Size = UDim2.new(0, 365, 0, 43)
			...
			ToggleFrame.BackgroundColor3 = Color3.fromRGB(180, 40, 40)
			...
			Toggle.MouseButton1Click:Connect(function()
				...
				-- AutoSave
				SaveData[text] = Toggled
				AutoSave()
			end)
			
			ArrowBtn.MouseButton1Click:Connect(function()
				if ToggleDescToggled == false then
					Toggle:TweenSize(UDim2.new(0, 365, 0, 74), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
					...
					Toggle:TweenSize(UDim2.new(0, 365, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
			...
			if default == true then
				...
				Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
			-- Registrar toggle no search
			table.insert(SearchRegistry, {text = text, tabName = TabTitle.Text, callback = function() end})
		end
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if SliderDescToggled == false then
					Slider:TweenSize(UDim2.new(0, 365, 0, 101), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
					...
					Slider:TweenSize(UDim2.new(0, 365, 0, 60), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
				...
				-- Also allow clicking anywhere on the SlideFrame to jump
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Dropdown.ClipsDescendants = true
			Dropdown.Position = UDim2.new(0.110937499, 0, 0.67653507, 0)
			Dropdown.Size = UDim2.new(0, 365, 0, 43)
			...
			Dropdown.MouseButton1Click:Connect(function()
				if DropToggled == false then
					...
					Title.Text = Selected
					Dropdown:TweenSize(UDim2.new(0, 365, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
			...
			Item.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Colorpicker.ClipsDescendants = true
			Colorpicker.Position = UDim2.new(0.110937499, 0, 0.67653507, 0)
			Colorpicker.Size = UDim2.new(0, 365, 0, 43)
			...
			ColorpickerBtn.Size = UDim2.new(0, 365, 0, 42)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			...
			ColorpickerBtn.MouseButton1Click:Connect(function()
				if ColorPickerToggled == false then
					...
					Colorpicker:TweenSize(UDim2.new(0, 365, 0, 138), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
					...
					ColorSelection.Visible = false
					HueSelection.Visible = false
					Colorpicker:TweenSize(UDim2.new(0, 365, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Line()
			...
			Line.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Line.ClipsDescendants = true
			Line.Position = UDim2.new(0, 0, 0.70091325, 0)
			Line.Size = UDim2.new(0, 365, 0, 4)
		...
		function ContainerContent:Label(text)
			...
			Label.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Label.ClipsDescendants = true
			Label.Position = UDim2.new(0.370312512, 0, 0.552631557, 0)
			Label.Size = UDim2.new(0, 365, 0, 43)
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Textbox.ClipsDescendants = true
			Textbox.Position = UDim2.new(0.0459499061, 0, 0.734449744, 0)
			Textbox.Size = UDim2.new(0, 365, 0, 43)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if TextboxDescToggled == false then
					Textbox:TweenSize(UDim2.new(0, 365, 0, 81), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = PresetColor}
					...
					Textbox:TweenSize(UDim2.new(0, 365, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255,255,255)}
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Bind.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			Bind.ClipsDescendants = true
			Bind.Position = UDim2.new(0.40625, 0, 0.828947306, 0)
			Bind.Size = UDim2.new(0, 365, 0, 43)
		...
		-- ─── KEYBIND ELEMENT ───────────────────────
		function ContainerContent:Keybind(text, defaultKey, callback)
			defaultKey = defaultKey or Enum.KeyCode.F
			local currentKey = defaultKey
			if SaveData["kb_"..text] then
				pcall(function() currentKey = Enum.KeyCode[SaveData["kb_"..text]] end)
			end

			local KbFrame = Instance.new("TextButton")
			local KbCorner = Instance.new("UICorner")
			local KbDot = Instance.new("Frame")
			local KbDotCorner = Instance.new("UICorner")
			local KbTitle = Instance.new("TextLabel")
			local KbLabel = Instance.new("TextLabel")
			local KbLabelBox = Instance.new("Frame")
			local KbLabelBoxCorner = Instance.new("UICorner")

			KbFrame.Name = "KeybindElement"
			KbFrame.Parent = Container
			KbFrame.BackgroundColor3 = Color3.fromRGB(55, 10, 10)
			KbFrame.BorderSizePixel = 0
			KbFrame.Size = UDim2.new(0, 365, 0, 40)
			KbFrame.AutoButtonColor = false
			KbFrame.Font = Enum.Font.SourceSans
			KbFrame.Text = ""
			...
			KbDot.Parent = KbFrame
			KbDot.BackgroundColor3 = Color3.fromRGB(200, 60, 60)
			KbDot.AnchorPoint = Vector2.new(0, 0.5)
			KbDot.Position = UDim2.new(0, 12, 0.5, 0)
			KbDot.Size = UDim2.new(0, 9, 0, 9)
			KbDotCorner.CornerRadius = UDim.new(1, 0)
			KbDotCorner.Parent = KbDot
			...
			KbTitle.TextSize = 13
			KbTitle.TextTransparency = 0.2
			KbTitle.TextXAlignment = Enum.TextXAlignment.Left

			KbLabelBox.Parent = KbFrame
			KbLabelBox.BackgroundColor3 = Color3.fromRGB(80, 12, 12)
			KbLabelBox.AnchorPoint = Vector2.new(1, 0.5)
			KbLabelBox.Position = UDim2.new(1, -10, 0.5, 0)
			KbLabelBox.Size = UDim2.new(0, 70, 0, 26)
			KbLabelBoxCorner.CornerRadius = UDim.new(0, 4)
			KbLabelBoxCorner.Parent = KbLabelBox

			KbLabel.Parent = KbLabelBox
			KbLabel.BackgroundTransparency = 1
			KbLabel.Size = UDim2.new(1, 0, 1, 0)
			KbLabel.Font = Enum.Font.GothamBold
			KbLabel.Text = currentKey.Name
			KbLabel.TextColor3 = Color3.fromRGB(220, 80, 80)
			KbLabel.TextSize = 12
			...
			KbFrame.MouseButton1Click:Connect(function()
				...
				listening = true
				KbLabel.Text = "..."
				TweenService:Create(KbLabelBox, TweenInfo.new(.2), {BackgroundColor3 = Color3.fromRGB(120, 20, 20)}):Play()
				local conn
				conn = UserInputService.InputBegan:Connect(function(inp, gp)
					...
					if inp.KeyCode ~= Enum.KeyCode.Unknown then
						...
						SaveData["kb_"..text] = inp.KeyCode.Name
						AutoSave()
						TweenService:Create(KbLabelBox, TweenInfo.new(.2), {BackgroundColor3 = Color3.fromRGB(80, 12, 12)}):Play()
						listening = false
						conn:Disconnect()
					end
				end)
			...
			table.insert(KeybindRegistry, {key = currentKey, callback = function() pcall(callback) end})
			table.insert(SearchRegistry, {text = text.." [Keybind]", tabName = TabTitle.Text, callback = callback})
			Container.CanvasSize = UDim2.new(0, 0, 0, ContainerLayout.AbsoluteContentSize.Y)
		end
...
-- ═══════════════════════════════════════════
-- FLUX GLOBAL NOTIFY (Toast popup, no modal)
-- ═══════════════════════════════════════════
function Flux:Notify(opts)
	-- opts = {title, desc, duration, icon}
	opts = opts or {}
	local title    = opts.title    or "Notificação"
	local desc     = opts.desc     or ""
	local duration = opts.duration or 4
	local icon     = ResolveIcon(opts.icon or "")
	...
	local ToastBarFill = Instance.new("Frame")
	local ToastBarCorner = Instance.new("UICorner")
	local ToastBarFillCorner = Instance.new("UICorner")

	Toast.Name = "Toast"
	Toast.Parent = FluxLib
	Toast.AnchorPoint = Vector2.new(1, 1)
	Toast.BackgroundColor3 = Color3.fromRGB(28, 6, 6)
	Toast.BorderSizePixel = 0
	Toast.Position = UDim2.new(0.98, 0, 0.98, 60)
	...
	TGrad.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(55, 8, 8)),
	...
	ToastGlow.Position = UDim2.new(0, -10, 0, -10)
	ToastGlow.Size = UDim2.new(1, 20, 1, 20)
	ToastGlow.ZIndex = 199
	ToastGlow.Image = "rbxassetid://4996891970"
	ToastGlow.ImageColor3 = Color3.fromRGB(160, 20, 20)
	ToastGlow.ImageTransparency = 0.5
	ToastGlow.ScaleType = Enum.ScaleType.Slice
	ToastGlow.SliceCenter = Rect.new(20, 20, 280, 280)

	if icon ~= "" then
		ToastIcon.Name = "ToastIcon"
		ToastIcon.Parent = Toast
		ToastIcon.BackgroundTransparency = 1
		ToastIcon.Position = UDim2.new(0, 10, 0.5, -12)
		ToastIcon.Size = UDim2.new(0, 24, 0, 24)
		ToastIcon.Image = icon
		ToastIcon.ImageColor3 = Color3.fromRGB(220, 80, 80)
		ToastIcon.ZIndex = 201
	end

	local textOffsetX = icon ~= "" and 44 or 12

	ToastTitle.Name = "ToastTitle"
	ToastTitle.Parent = Toast
	ToastTitle.BackgroundTransparency = 1
	ToastTitle.Position = UDim2.new(0, textOffsetX, 0, 8)
	ToastTitle.Size = UDim2.new(1, -textOffsetX - 8, 0, 22)
	ToastTitle.Font = Enum.Font.GothamBold
	ToastTitle.Text = title
	ToastTitle.TextColor3 = Color3.fromRGB(255, 220, 220)
	...
	ToastDesc.Position = UDim2.new(0, textOffsetX, 0, 30)
	ToastDesc.Size = UDim2.new(1, -textOffsetX - 8, 0, 28)
	ToastDesc.Font = Enum.Font.Gotham
	ToastDesc.Text = desc
	ToastDesc.TextColor3 = Color3.fromRGB(200, 150, 150)
	ToastDesc.TextSize = 11
	ToastDesc.TextTransparency = 0.2
	ToastDesc.TextXAlignment = Enum.TextXAlignment.Left
	ToastDesc.TextWrapped = true
	ToastDesc.ZIndex = 201

	-- Progress bar at bottom
	ToastBar.Name = "ToastBar"
	ToastBar.Parent = Toast
	ToastBar.BackgroundColor3 = Color3.fromRGB(40, 8, 8)
	ToastBar.BorderSizePixel = 0
	ToastBar.Position = UDim2.new(0, 0, 1, -4)
	ToastBar.Size = UDim2.new(1, 0, 0, 4)
	ToastBar.ZIndex = 202

	ToastBarCorner.CornerRadius = UDim.new(0, 2)
	ToastBarCorner.Parent = ToastBar

	ToastBarFill.Name = "Fill"
	ToastBarFill.Parent = ToastBar
	ToastBarFill.BackgroundColor3 = Color3.fromRGB(200, 40, 40)
	ToastBarFill.BorderSizePixel = 0
	ToastBarFill.Size = UDim2.new(1, 0, 1, 0)
	ToastBarFill.ZIndex = 203

	ToastBarFillCorner.CornerRadius = UDim.new(0, 2)
	ToastBarFillCorner.Parent = ToastBarFill

	-- Slide in
	TweenService:Create(Toast, TweenInfo.new(.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
		{Position = UDim2.new(0.98, 0, 0.98, 0)}):Play()
	-- Progress bar drain
	TweenService:Create(ToastBarFill, TweenInfo.new(duration, Enum.EasingStyle.Linear),
		{Size = UDim2.new(0, 0, 1, 0)}):Play()

	coroutine.wrap(function()
		wait(duration)
		TweenService:Create(Toast, TweenInfo.new(.3, Enum.EasingStyle.Quart, Enum.EasingDirection.In),
			{Position = UDim2.new(0.98, 0, 0.98, 80)}):Play()
		wait(.35)
		Toast:Destroy()
	end)()
end
...
-- ═══════════════════════════════════════════
-- FLUX GLOBAL KEYBIND REGISTRATION
-- ═══════════════════════════════════════════
function Flux:AddKeybind(key, callback)
	table.insert(KeybindRegistry, {key = key, callback = callback})
end
